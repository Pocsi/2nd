...
export default function TransactionProcess() {
  ...
  const calculateCryptoAmount = (fiatAmount: number, cryptoSymbol: string): number => {
    const crypto = cryptoOptions.find(c => c.symbol === cryptoSymbol);
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-custom p-6 overflow-hidden">
            ...
            <div className="bg-white p-4 rounded-md border border-gray-200 mb-6">
              ...
              <div className="mb-2">
                <input 
                  ...
                  className="w-full p-2 text-sm border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-accent"
                />
              </div>
            ...
            <div className="flex space-x-4">
              <button className="flex-1 py-3 border border-gray-300 rounded-md text-primary font-medium hover:bg-gray-50 transition-colors">
                Back
              </button>
              <button className="flex-1 py-3 bg-primary text-white rounded-md font-medium hover:bg-opacity-90 transition-colors">
                Continue
              </button>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-custom p-6 overflow-hidden">
            ...
            <div className="bg-secondary rounded-lg p-4 mb-6">
              ...
              <div className="flex space-x-2 mb-4">
                <button className="flex-1 py-2 bg-white border border-gray-300 rounded-md text-sm flex items-center justify-center">
